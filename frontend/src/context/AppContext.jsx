...
export function AppProvider({children}){
 ...
 return <Context.Provider value={{lang,setLang,tr,user,setUser,lessons,addLesson,updateLesson,deleteLesson,settings,setSettings,logout,demoLogin,loading,loadError,refresh,storageError}}>{children}</Context.Provider>
}
